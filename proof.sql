...
VALUES (9999, (SELECT invoice_id FROM invoice LIMIT 1), 100.00, CURRENT_DATE);
...
-- violates check constraint "check_amount_applied"
-- (SQLSTATE 23514)
...
-- violates check constraint "check_payment_method"
-- (SQLSTATE 23514)